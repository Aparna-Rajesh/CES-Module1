...
# colorlist = [[[253, 231, 36], [78, 1, 94]], [[42, 106, 219], [227, 95, 50]], [[12, 201, 34], [33, 207, 204]], [[140, 33, 217], [23, 230, 209]], [[230, 51, 23], [237, 121, 198]]]


# Function to update the lava lamp display
...
#         root.update()
#         time.sleep(0.06)
#         # time.sleep(0.06 - (0.04 * (joy_y - 1885)/2500))
...
#     speed_factor = 0.004   # Factor by which speed changes relative to joystick displacement
...
#         speed_adjustment = (joy_y_int - neutral_position) * speed_factor
#         sleep_time = max(0, base_sleep_time - speed_adjustment)  # Ensure non-negative sleep time
